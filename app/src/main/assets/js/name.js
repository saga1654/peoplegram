    ...
    function type_chart(my_speed, my_control, people_speed, people_control)
    	{
    		...
    		if((my_type == "I1" && people_type == "I1") || (my_type == "I1" && people_type == "I2") || (my_type == "I1" && people_type == "I3") || (my_type == "I1" && people_type == "I4") || (my_type == "I2" && people_type == "I1") || (my_type == "I2" && people_type == "I2") || (my_type == "I2" && people_type == "I3") || (my_type == "I2" && people_type == "I4")|| (my_type == "I3" && people_type == "I1") || (my_type == "I3" && people_type == "I2") || (my_type == "I3" && people_type == "I3") || (my_type == "I3" && people_type == "I4") || (my_type == "I4" && people_type == "I1") || (my_type == "I4" && people_type == "I2") || (my_type == "I4" && people_type == "I3") || (my_type == "I4" && people_type == "I4") || (my_type == "D1" && people_type == "D1") || (my_type == "D1" && people_type == "D2") || (my_type == "D1" && people_type == "D3") || (my_type == "D1" && people_type == "D4") || (my_type == "D2" && people_type == "D1") || (my_type == "D2" && people_type == "D2") || (my_type == "D2" && people_type == "D3") || (my_type == "D2" && people_type == "D4")|| (my_type == "D3" && people_type == "D1") || (my_type == "D3" && people_type == "D2") || (my_type == "D3" && people_type == "D3") || (my_type == "D3" && people_type == "D4") || (my_type == "D4" && people_type == "D1") || (my_type == "D4" && people_type == "D2") || (my_type == "D4" && people_type == "D3") || (my_type == "D4" && people_type == "D4") || (my_type == "E1" && people_type == "E1") || (my_type == "E1" && people_type == "E2") || (my_type == "E1" && people_type == "E3") || (my_type == "E1" && people_type == "E4") || (my_type == "E2" && people_type == "E1") || (my_type == "E2" && people_type == "E2") || (my_type == "E2" && people_type == "E3") || (my_type == "E2" && people_type == "E4")|| (my_type == "E3" && people_type == "E1") || (my_type == "E3" && people_type == "E2") || (my_type == "E3" && people_type == "E3") || (my_type == "E3" && people_type == "E4") || (my_type == "E4" && people_type == "E1") || (my_type == "E4" && people_type == "E2") || (my_type == "E4" && people_type == "E3") || (my_type == "E4" && people_type == "E4") || (my_type == "A1" && people_type == "A1") || (my_type == "A1" && people_type == "A2") || (my_type == "A1" && people_type == "A3") || (my_type == "A1" && people_type == "A4") || (my_type == "A2" && people_type == "A1") || (my_type == "A2" && people_type == "A2") || (my_type == "A2" && people_type == "A3") || (my_type == "A2" && people_type == "A4")|| (my_type == "A3" && people_type == "A1") || (my_type == "A3" && people_type == "A2") || (my_type == "A3" && people_type == "A3") || (my_type == "A3" && people_type == "A4") || (my_type == "A4" && people_type == "A1") || (my_type == "A4" && people_type == "A2") || (my_type == "A4" && people_type == "A3") || (my_type == "A4" && people_type == "A4") ){
                     my_contents  =  "본인과 타인 모두 <b class = 'Name1'></b>님의 모습을 잘 알고 있음<br>행동이 일관되어 타인도 예측 가능함<br><b class = 'Name1'></b>님의 인간 관계 스트레스도 적은 편임<br><br><b class = 'Name1'></b>님 자신이 바라보는 모습과 타인이 <b class = 'Name1'></b>님을 바라보는 모습이 일치합니다. <br> 평소 <b class = 'Name1'></b></b>님은 [gubun1] 관계에서 [my_type]의 일관된 행동 모습을 보여 주고 있습니다. <br>또한 다른 사람들도 <b class = 'Name1'></b>님의 행동을 일관되게 [피플타입1]으로 파악하고 예측하고 있어 [gubun1] 관계에서 상호 간의 소통과 행동에 어려움이 없습니다. <br> <b class = 'Name1'></b>님은 평소 [gubun1] 관계에서 자신이 어떤 행동을 하고 있는지 잘 알고 있습니다.<br> 다른 사람 또한 <b class = 'Name1'></b>님이 예상에 어긋난 행동을 거의 보이지 않기 때문에 <b class = 'Name1'></b>님을 매우 잘 알고 있다고 생각합니다.<br> 즉 <b class = 'Name1'></b>님이나 주변 사람들 모두 [gubun1] 관계에서 <b class = 'Name1'></b>님과 어떻게 소통하고 행동하는 것이 훌륭한 인간 관계를 맺고 지속할 수 있는지 잘 알고 있습니다. <br> 따라서 <b class = 'Name1'></b>님은 [gubun1] 관계 내에서 인간 관계에 따른 스트레스는 상대적으로 적을 가능성이 높습니다.<br>";
				...
				my_contents  =  "본인은 타인에게 비치는 자신의 모습을 거의 알고 있음<br>본인의 행동이 어느 정도 일관되어 타인도 거의 예측 가능함.<br><b class = 'Name1'></b>님은 인간 관계 스트레스가 어느 정도 있음<br><br><b class = 'Name1'></b>자신이 바라보는 모습과 타인이 <b class = 'Name1'></b>님을 바라보는 모습이 다소 불일치합니다. <br>평소 <b class = 'Name1'></b></b>님은 [gubun1] 관계에서 [my_type]의 행동을 보여주고 있다고 생각하지만, 다른 사람들은 약간의 차이가 있는 [people_type]의 행동을 하고 있다고 생각합니다.<br>이로 인해 다른 사람들은 <b class = 'Name1'></b>님을 대할 때 [people_type]에 맞춰 소통하고 행동하지만 간혹 예상과 다른 [my_type]]의 행동이 나타나 당황스러울 수 있을 것입니다. <br><b class = 'Name1'></b>님은 평소 [gubun1] 관계에서 자신이 일관되게 어떤 행동을 하고 있는지 대부분은 잘 알고 있으나, 간혹 자신도 몰랐던 행동을 하거나 본인이 드러내고 싶지 않은 행동을 하는 경우도 있습니다.<br>다른 사람들은 <b class = 'Name1'></b>님이 예상에 어긋난 다른 행동을 보일 경우 평소 알고 있던 <b class = 'Name1'></b>님이 아니기 때문에 당황할 수 있어 <b class = 'Name1'></b>님과 인간 관계에서 거리를 둘 수 있습니다.<br>이로 인해 <b class = 'Name1'></b>님은 [gubun1] 관계 내에서 인간 관계에 따른 스트레스를 받을 수 있습니다.<br>훌륭한 인간 관계를 맺기 위해서 <b class = 'Name1'></b>님은 [gubun1] 관계에서 자신의 행동을 일관되게 할 필요가 있습니다. <br>그러기 위해서는 자신이 미처 몰랐던 자신의 행동은 타인의 판단을 존중하고 수용하여 자신의 모습으로 인정할 수 있어야 합니다. <br>또한 자신의 처한 환경과 역할, 관계에 따라 통제하고 숨겨왔던 자신의 모습은 조금씩 드러내어 솔직한 모습 그대로 사람들과 관계를 맺을 필요가 있습니다.<br>";
		    	...
		    	my_contents  = "본인은 타인에게 비치는 자신의 모습을 잘 모르고 있거나 드러내지 않고 있음<br>본인의 행동이 일관되지 않아 타인이 예측하기 어려움<br><b class = ‘Name1’></b>님은 인간 관계 스트레스가 있음<br><br><b class = ‘Name1’></b>님 자신이 바라보는 모습과 타인이 <b class = ‘Name1’></b>님을 바라보는 모습이 불일치합니다. <br>평소 <b class = ‘Name1’></b>님은 [gubun1] 관계에서 [my_type]의 행동을 보여주고 있다고 생각하지만, 다른 사람들은 ><b class = ‘Name1’></b>님의 생각과 차이가 큰 [people_type]의 행동을 하고 있다고 생각합니다.<br>이로 인해 다른 사람들은 <b class = ‘Name1’></b>님을 대할 때 [people_type]에 맞춰 소통하고 행동하려 하지만 장홍기님은 예상과 다른 [my_type]]의 행동을 보여 당황스러울 것입니다. <br><b class = ‘Name1’></b>님은 평소 [gubun1] 관계에서 자신이 어떤 행동을 하고 있는지 잘 알고 있지 못하며, [gubun1] 관계에서 자신도 몰랐던 행동을 하거나 본인이 드러내고 싶지 않은 행동을 자주 하는 편입니다.<br>다른 사람들은 <b class = ‘Name1’></b>님이 예상에 어긋난 다른 행동을 보일 경우 평소 알고 있던 <b class = ‘Name1’></b>님이 아니기 때문에 당황할 수 있어 <b class = ‘Name1’></b>님과 인간 관계에서 거리를 둘 수 있습니다.<br>이로 인해 <b class = ‘Name1’></b>님은 [gubun1] 관계 내에서 인간 관계를 잘 풀어가기 어려워 그에 따른 강한 스트레스를 받을 수 있습니다.<br>훌륭한 인간 관계를 맺기 위해서 <b class = ‘Name1’></b>님은 [gubun1] 관계에서 자신의 행동을 일관되게 할 필요가 있습니다. <br>그러기 위해서는 자신이 미처 몰랐던 자신의 행동은 타인의 판단을 존중하고 수용하여 자신의 모습으로 인정할 수 있어야 합니다.<br> 또한 자신의 처한 환경과 역할, 관계에 따라 통제하고 숨겨왔던 자신의 모습은 조금씩 드러내어 솔직한 모습 그대로 사람들과 관계를 맺을 필요가 있습니다.<br>";
		    }else{
		    	my_contents  ="<b class = ‘Name1’></b>님 자신이 바라보는 모습과 타인이 <b class = ‘Name1’></b>님을 바라보는 모습이 전혀 다릅니다. <br>평소 <b class = ‘Name1’></b>님은 [gubun1] 관계에서 [my_type]의 행동을 보여주고 있다고 생각하지만, 다른 사람들은 <b class = ‘Name1’></b>님의 생각과 전혀 다른 [people_type]의 행동을 하고 있다고 생각합니다.<br>이로 인해 다른 사람들은 <b class = ‘Name1’></b>님을 대할 때 [people_type]에 맞춰 소통하고 행동하려 하지만 <b class = ‘Name1’></b>님은 예상과 전혀 다른 [my_type]의 행동을 보여 매우 당황스러울 것입니다. <br><b class = ‘Name1’></b>님은 평소 [gubun1] 관계에서 자신이 어떤 행동을 하고 있는지 전혀 알고 있지 못하며, [gubun1] 관계에서 자신도 전혀 몰랐던 행동을 하거나 본인의 원래 모습을 꽁꽁 숨겨 두고 있을 가능성이 높습니다.<br>다른 사람들은 <b class = ‘Name1’></b>님이 예상에 어긋난 다른 행동을 보일 경우 평소 알고 있던 <b class = ‘Name1’></b>님이 전혀 아니기 때문에 매우 당황할 수 있어 <b class = ‘Name1’></b>님과 인간 관계에서 많은 거리를 둘 수 있습니다.<br>이로 인해 <b class = ‘Name1’></b>님은 [gubun1] 관계 내에서 인간 관계를 잘 풀어가기 어려워 그에 따른 매우 강한 스트레스를 받을 수 있습니다.<br><br>훌륭한 인간 관계를 맺기 위해서 <b class = ‘Name1’></b>님은 [gubun1] 관계에서 자신의 행동을 일관되게 할 필요가 있습니다.<br> 그러기 위해서는 자신이 미처 몰랐던 자신의 행동은 타인의 판단을 존중하고 수용하여 자신의 모습으로 인정할 수 있어야 합니다.<br> 또한 자신의 처한 환경과 역할, 관계에 따라 강하게 통제하고 숨겨왔던 자신의 모습은 조금씩 드러내어 솔직한 모습 그대로 사람들과 관계를 맺을 필요가 있습니다.<br>";
		    }
