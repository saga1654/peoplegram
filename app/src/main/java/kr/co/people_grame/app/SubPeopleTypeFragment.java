...
public class SubPeopleTypeFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tv_mytype1.setText(Html.fromHtml("가족들이 생각하는 <b color='#32354d;'>"+username+"</b> 님의타입"));
        tv_mytype2.setText(Html.fromHtml("친구들이 생각하는 <b color='#32354d;'>"+username+"</b> 님의타입"));
        tv_mytype3.setText(Html.fromHtml("연인이 생각하는 <b color='#32354d;'>"+username+"</b> 님의타입"));
        tv_mytype4.setText(Html.fromHtml("직장에서 생각하는 <b color='#32354d;'>"+username+"</b> 님의타입"));
        tv_mytype5.setText(Html.fromHtml("고객들이 생각하는 <b color='#32354d;'>"+username+"</b> 님의타입"));
