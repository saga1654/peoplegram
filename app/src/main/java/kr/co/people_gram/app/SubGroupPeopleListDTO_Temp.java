 ...
 */
public class SubGroupPeopleListDTO_Temp {
    String profile_uid = "";
    String profile_img = "";
    ...
    public SubGroupPeopleListDTO_Temp() {

    }

    public SubGroupPeopleListDTO_Temp(String profile_uid, String profile_img, String profile_username, String profile_email, String profile_type, String profile_mood, String profile_gubun1, String profile_gubun2, int profile_speed, int profile_control, int group_count, Boolean checked)
    {
