...
public class SubPeopleMatchListDTO {
    ...
    public SubPeopleMatchListDTO(String profile_uid, String profile_username, String profile_email, String profile_type, String profile_gubun1, String profile_gubun2, int profile_people_speed, int profile_people_control, int profile_total_value, int profile_score_temp, double profile_match_value, int profile_user_count)
    {
