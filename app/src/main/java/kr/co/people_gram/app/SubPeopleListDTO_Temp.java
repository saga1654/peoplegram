 ...
 */
public class SubPeopleListDTO_Temp {
    String profile_uid = "";
    String profile_img = "";
    ...
    public SubPeopleListDTO_Temp() {

    }

    public SubPeopleListDTO_Temp(String profile_uid, String profile_img, String profile_username, String profile_email, String profile_type, String profile_mood, String profile_gubun1, String profile_gubun2, int profile_speed, int profile_control, int profile_cnt, int profile_friend_cnt, int profile_new_cnt)
    {
