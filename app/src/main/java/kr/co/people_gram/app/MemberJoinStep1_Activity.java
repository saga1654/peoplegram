...
public class MemberJoinStep1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            HttpClient.post("/user/telephoneCheck", params, new AsyncHttpResponseHandler() {
                public void onStart() {
                    dialog = ProgressDialog.show(MemberJoinStep1_Activity.this, "", "데이터 수신중");
                }
                ...
                public void onSuccess(String response) {
                    ...
                    if(response.equals("999")) {
                        ...
                        alert.setMessage("가입된 내역이 존재합니다.다시 확인 부탁드립니다.");
                        alert.show();
                    }
