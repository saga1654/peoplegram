...
public class RoundKnobButton extends RelativeLayout implements OnGestureListener {
    ...
    private RelativeLayout.LayoutParams lp_ivBack;
    ...
    public RoundKnobButton(Context context, int back, int rotoron, int rotoroff, final int w, final int h) {
        ...
        lp_ivBack = new RelativeLayout.LayoutParams(
                w,h);
    ...
    public void setRotorPosAngle(float deg) {
        ...
        //Log.d("people_gram", "좌표="+String.valueOf(deg));
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        ...
        if (! Float.isNaN(rotDegrees)) {
            ...
            //if (posDegrees > 210 || posDegrees < 150) {
                ...
                Log.d("people_gram", String.valueOf(rotDegrees) + ":::" + String.valueOf(scaleDegrees));

                if(rotDegrees > 0 && rotDegrees <= 50) {
                   ivBack.setImageResource(R.drawable.myfilling_line_bg1);
                } else if (rotDegrees > 50 && rotDegrees <= 100){
                    ivBack.setImageResource(R.drawable.myfilling_line_bg2);
                } else if(rotDegrees > 101 && rotDegrees  <= 150) {
                    ivBack.setImageResource(R.drawable.myfilling_line_bg3);
                } else if(rotDegrees  > 151 && rotDegrees <= 180) {
                    ivBack.setImageResource(R.drawable.myfilling_line_bg4);
                } else if(rotDegrees  > -180 && rotDegrees <= -151) {
                    ivBack.setImageResource(R.drawable.myfilling_line_bg4);
                } else if(rotDegrees  > -150 && rotDegrees <= -101) {
                    ivBack.setImageResource(R.drawable.myfilling_line_bg5);
                } else if(rotDegrees  > -100 && rotDegrees <= -51) {
                    ivBack.setImageResource(R.drawable.myfilling_line_bg6);
                } else if(rotDegrees  > -50 && rotDegrees <= -1) {
                    ivBack.setImageResource(R.drawable.myfilling_line_bg7);
                }
